  ...
  <div class="container">
        ...
        <div class="row">
        	<div class="col-xs-12">
                ...
                <p>Ono Jirōemon Tadaaki, il successore designato e rinomato uomo di spada, fond&ograve; Onoha, e divenne il Maestro d'armi del secondo e terzo shogun della dinastia Tokugawa, cosa che fu fonte di grande prestigio.<br/>
                Da allora l'Onoha Ittō Ryū Kenjutsu divenne una delle due scuole di spada ufficiali per la formazione dei samurai dello Shogun formando nel tempo maestri di spada leggendari che lasciarono una profonda impronta nella storia del Giappone.</p>
                <p></p>
       ...
       <div class="row">
            <div class="col-xs-12 col-md-6 col-lg-6">
                 <p>L'attuale caposcuole &egrave; il Sōke Sasamori Takemi, il diciassettesimo Sōke, che ha ereditato la tradizione da suo padre, Sasamori Junzo, e che ha condotto la scuola nel 21esimo secolo.</p>
            ...
            <div class="col-xs-12 col-md-6 col-lg-6">
                <div class="acenter pad">
                    ...
                    <p>Il gruppo di pratica di Pesaro, al seminario internazionale con il Sōke Sasamori Takemi, Giugno 2015.</p>
                </div>                
            </div>
        </div>
