  ...
  <div class="container">
      ...
      <div class="row">
        <p><br/>&nbsp;&nbsp;&nbsp;You can reach us in one of these ways:
            <ul>
              <li>come and see us in our dojo, in Pesaro or Rimini, during classes.
      ...
      <div class="row">
          <div class="col-md-6 col-xs-12">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                (enter in via Tancredi Saletta, lefthand side of the building)<br/>
                <div>
        ...
        <div class="row">
            <div class="col-xs-12 text-center">    
                 <h2 name="schedule" class="text-primary">Class schedule</h2>
            </div>
        </div>
        <div class="row">
